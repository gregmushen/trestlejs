...
const before = current === "0.1.0-beta.2" || current === "0.1.0-beta.3" ? "0.1.0-alpha.135" : betaCandidate ? "0.1.0-alpha.134" : `0.1.0-alpha.${Number(match[1]) - 2}`;
const after = current === "0.1.0-beta.2" || current === "0.1.0-beta.3" ? "0.1.0-beta.1" : betaCandidate ? "0.1.0-alpha.135" : `0.1.0-alpha.${Number(match[1]) - 1}`;
