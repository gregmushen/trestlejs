...
export default defineAdminView({
  ...
  commands: [
    ...
    { id: "organizations.start-support-session", label: "Start support session", hotkey: "e", kind: "action", scope: "selection", requires: "an organization", permission: "platform.support_sessions.use", keywords: ["support", "tenant", "context", "ticket"] },
