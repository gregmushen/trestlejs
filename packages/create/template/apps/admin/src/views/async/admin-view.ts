...
export default defineAdminView({
  ...
  commands: [
    ...
    { id: "async.redrive", label: "Redrive the selected dead letter", hotkey: "r", kind: "action", scope: "selection", requires: "a dead letter", permission: "platform.outbox.redrive", keywords: ["retry", "dlq", "failed"] },
