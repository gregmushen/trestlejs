...
export default defineAdminView({
  ...
  commands: [
    ...
    { id: "permissions.focus-explorer", label: "Focus the Effective Access Explorer", hotkey: "x", kind: "focus", scope: "view", permission: "platform.roles.read", keywords: ["why", "denied", "debug"] },
  ],
});
