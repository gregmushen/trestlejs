...
export default function PermissionsView() {
  ...
  useAdminCommands({
    "permissions.focus-explorer": { enabled: can("platform.access.explain"), run: () => { explorer.current = document.getElementById("access-explorer"); explorer.current?.scrollIntoView({ block: "start" }); explorer.current?.querySelector<HTMLElement>("button, input")?.focus(); } },
    "permissions.new": { enabled: manage, run: () => setCreating(emptyPermission) },
  });
  ...
  return <>
    ...
    {can("platform.access.explain") && <AccessExplorer permissions={tenantCodes} />}
