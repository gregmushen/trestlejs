...
export default defineAdminView({
  ...
  commands: [
    ...
    { id: "audit.open-support-session", label: "Open the event's support session", hotkey: "s", kind: "action", scope: "selection", requires: "an event recorded in a support session", permission: "platform.support_sessions.use" },
  ],
});
