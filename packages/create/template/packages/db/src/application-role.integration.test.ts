...
suite("application role assignment persistence", () => {
  it("defaults new members to contributor and permits revocation without changing organization ownership", async () => {
    ...
    try {
      ...
      expect(initial).toEqual({ role: "owner", application_role: "contributor" });
